...
UnitEncoderCLightOutput = unitencoderc_ns.class_('UnitEncoderCLightOutput', light.LightOutput, cg.Component)
CONF_LIGHT = "light"

CONFIG_SCHEMA = light.RGB_LIGHT_SCHEMA.extend(
    {
        cv.GenerateID(CONF_ID): cv.declare_id(LightState),
        cv.GenerateID(CONF_OUTPUT_ID): cv.declare_id(UnitEncoderCLightOutput)
    }
