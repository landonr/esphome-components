...
static const char* const LIGHT_TAG = "unit_encoder_c_light";
static const uint8_t UNIT_ENCODER_C_LIGHT = 0x30;

class UnitEncoderCLightOutput : public Component,
 ...
 public:
  ...
  void setup() override {
    ...
    if (this->write_register(UNIT_ENCODER_C_LIGHT, data, 3) != i2c::ERROR_OK) {
      ESP_LOGE(LIGHT_TAG, "UnitEncoderC light set failed");
      this->mark_failed();
    }
  }
